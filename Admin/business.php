...
<a href="businessView.php"><font size= "1.5">Click Here to see student's view</a><br/>
...
<form id="s" method="post" action="business.php">
...
<p><font size="3">Identify the business ID of which you want to change the above value for :</p>
...
<p><font size="3">Insert a new business info into our Business database table below:</p>

<form method="POST" action="business.php">
<!-- refreshes page when submitted -->

   <p>
    <input type="text" placeholder="Business ID"name="insID" size="18">
    <input type="text" placeholder="Business Name" name="insName" size="18">
    <input type="text" placeholder="Business Type" name="insType" size="18">
    <input type="text" placeholder="Business Description" name="insDescription" size="18">
    <input type="text" placeholder="Business Contact" name="insContact" size="18">
...
<input type="submit" value="Insert Business Data" name="insertsubmit"></p>
<input type="submit" value="Clear Business Database" name="deleteAll"></p>
